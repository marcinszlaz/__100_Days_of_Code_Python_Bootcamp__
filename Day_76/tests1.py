...
# print(json.dumps(simple_text))
# print(type(json.dumps(simple_text)))
print(json.loads(simple_text))
print(type(json.loads(simple_text)))
list_simple_text = json.loads(simple_text)
with open('./new_file.txt','w') as file_w:
  json.dump(list_simple_text,fp=file_w,indent=2,sort_keys=True)
